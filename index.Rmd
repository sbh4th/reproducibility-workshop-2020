...
## 0. Introduction ([slides](slides/00-intro/00-intro.html))

## 1. Scientific Integrity Problems ([slides](slides/01-integrity/01-integrity.html))

## 2. Design Solutions ([slides](slides/02-design/02-design.html))

## 3. Analytic Solutions ([slides](slides/03-analytic/03-analytic.html))

## 4. Dissemination Solutions ([slides](slides/04-dissemination/04-dissemination.html))
