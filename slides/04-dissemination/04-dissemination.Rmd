...
.right-column[
.center[
![:scale 80%](same-sex-retraction.png)
]]
...
.left-column[
```{r, echo=F, out.height="100%", out.width="100%"}
knitr::include_graphics("materials_large_color.png")
```
]
.right-column[
### Credibility
