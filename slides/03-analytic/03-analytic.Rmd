...
.left[
`codebook_data <- rio::import("stata.dta")`  
`codebook(codebook_data)` `r emo::ji("point_down")`
]
.center[
![](codebook-r.png)
]
...
#### This means you, Excel. And you, copy/paste.
...
.right-column[
### Many papers contain multiple scripts.
